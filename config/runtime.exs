...
#
#     PHX_SERVER=true bin/leetcode_spaced start
#
...
if config_env() == :prod do
  ...
  config :leetcode_spaced, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :leetcode_spaced, LeetcodeSpaced.Mailer,
