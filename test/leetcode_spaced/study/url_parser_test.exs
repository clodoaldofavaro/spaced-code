defmodule LeetcodeSpaced.Study.UrlParserTest do
  ...
  describe "extract_title/1" do
    test "extracts title from standard LeetCode URL" do
      assert UrlParser.extract_title("https://leetcode.com/problems/flood-fill/description/") ==
               "Flood Fill"

      assert UrlParser.extract_title("https://leetcode.com/problems/two-sum/") == "Two Sum"

      assert UrlParser.extract_title("https://leetcode.com/problems/add-two-numbers/") ==
               "Add Two Numbers"
    end

    test "handles URLs with numbers at the start" do
      assert UrlParser.extract_title("https://leetcode.com/problems/3sum-closest/") ==
               "3sum Closest"
    ...
    test "handles complex problem names" do
      assert UrlParser.extract_title(
               "https://leetcode.com/problems/longest-palindromic-substring/"
             ) == "Longest Palindromic Substring"

      assert UrlParser.extract_title("https://leetcode.com/problems/merge-k-sorted-lists/") ==
               "Merge K Sorted Lists"
    end

    test "handles URLs with query parameters" do
      assert UrlParser.extract_title("https://leetcode.com/problems/flood-fill/?tab=description") ==
               "Flood Fill"
    end

    test "handles www subdomain" do
      assert UrlParser.extract_title("https://www.leetcode.com/problems/flood-fill/") ==
               "Flood Fill"
    end
  ...
  describe "extract_problem_slug/1" do
    test "extracts slug from various URL formats" do
      assert UrlParser.extract_problem_slug(
  ...
  describe "valid_leetcode_url?/1" do
    test "validates correct LeetCode URLs" do
      ...
      assert UrlParser.valid_leetcode_url?("http://leetcode.com/problems/add-two-numbers/") ==
               true

      assert UrlParser.valid_leetcode_url?(
