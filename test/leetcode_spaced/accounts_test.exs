defmodule LeetcodeSpaced.AccountsTest do
  use LeetcodeSpaced.DataCase

  alias LeetcodeSpaced.Accounts

  describe "users" do
    alias LeetcodeSpaced.Accounts.User

    import LeetcodeSpaced.AccountsFixtures

    @invalid_attrs %{name: nil, email: nil, google_id: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{name: "some name", email: "some email", google_id: "some google_id"}
