defmodule LeetcodeSpacedWeb.PageLive do
  use LeetcodeSpacedWeb, :live_view
    ...
    socket =
      socket
      |> assign(current_theme: "system") # Start with system, will be updated by JS
              ...
              <%= if @current_user do %>
                <div class="flex items-center space-x-3">
                  <%= if @current_user.avatar_url && @current_user.avatar_url != "" do %>
                    ...
                    >
                    <div class="w-8 h-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white font-semibold text-sm" style="display: none;">
                  ...
                  <.link href="/auth/logout" class="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md">
                    Logout
                  </.link>
                </div>
              <% else %>
                <.link href="/auth/google" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md">
                  Sign in with Google
                </.link>
              <% end %>
            </div>
      ...
      <div class="bg-gradient-to-b from-base-200 to-base-100 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <% else %>
            ...
            <.link href="/auth/google" class="inline-flex items-center bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white text-lg px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="grid md:grid-cols-3 gap-8">
            <div class="text-center group">
              ...
              <p class="text-base-content/70">Create custom lists and organize problems by topic, difficulty, or interview prep</p>
            </div>
            ...
            <div class="text-center group">
              ...
              <p class="text-base-content/70">Review problems at scientifically optimal intervals to maximize retention</p>
            </div>
            ...
            <div class="text-center group">
              ...
              <p class="text-base-content/70">Visualize your improvement and identify weak areas to focus on</p>
            </div>
          </div>
        </div>
      </div>
