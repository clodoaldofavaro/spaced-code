        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            <div class="flex items-center space-x-4">
              ...
              <span class="text-base-content/80">Lists</span>
            </div>
            <div class="flex items-center space-x-4">
              <%= if @current_user do %>
      ...
      <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8 flex items-center justify-between">
          <div>
            ...
            <p class="text-base-content/70 mt-2">Organize your coding practice with custom problem lists</p>
          </div>
        ...
        <%= if @show_form do %>
          <div class="mb-8 bg-base-200 rounded-xl p-6 border border-base-300">
            ...
            <.form for={@form} phx-submit="create_list" class="space-y-4">
              ...
              <.input field={@form[:description]} type="textarea" label="Description" placeholder="Enter list description..." />
